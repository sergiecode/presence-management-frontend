...
class ApiConstants {
  ...
  /// Para Docker/WSL: usar IP de WSL (172.29.80.1)
  /// Para emulador: usar 10.0.2.2
  static const String baseUrl = 'http://172.29.80.1:8080'; // IP de Docker/WSL para dispositivo físico
  
  /// URL alternativa para emulador de Android
