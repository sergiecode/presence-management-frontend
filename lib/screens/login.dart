...
import 'package:presence_management_frontend/screens/home_screen.dart';
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget> [
                        ...
                        SizedBox(height: 40),
                        FadeAnimation(1.3, Text('¿Olvidaste tu contraseña?', style: TextStyle(color: Colors.black, fontSize: 16))),
                        SizedBox(height: 40),
                        ...
                        FadeAnimation(1.7, GestureDetector(
                          ...
                          child: Column(
                            children: <Widget>[
                              Image.asset('assets/icons/face_id.png', height: 30),
                              const SizedBox(height: 8),
                              const Text('Face ID', style: TextStyle(color: Colors.black, fontSize: 16, fontWeight: FontWeight.bold)),
                            ],
                          ),
                        )),
                        SizedBox(height: 40), 
